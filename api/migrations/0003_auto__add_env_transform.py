...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CloudEnv'
        db.create_table('cloud_env', (
            ...
            ('network_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('env_type', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal('api', ['CloudEnv'])

        # Adding model 'EnvTransform'
        db.create_table('env_transform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
            ('env_pat', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('hwtype_pat', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('carrier_region_pat', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('setting_name_pat', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('value_pat', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('value_sub', self.gf('django.db.models.fields.CharField')(max_length=8000, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal('api', ['EnvTransform'])


    def backwards(self, orm):
        # Deleting model 'CloudEnv'
        db.delete_table('cloud_env')

        # Deleting model 'EnvTransform'
        db.delete_table('env_transform')
