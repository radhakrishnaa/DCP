...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ExtraValue', fields ['value']
        db.delete_unique('extra_value', ['value'])

        # Adding unique constraint on 'ExtraValue', fields ['extra_key_id', 'value']
        db.create_unique('extra_value', ['extra_key_id', 'value'])


    def backwards(self, orm):
        # Removing unique constraint on 'ExtraValue', fields ['extra_key_id', 'value']
        db.delete_unique('extra_value', ['extra_key_id', 'value'])

        # Adding unique constraint on 'ExtraValue', fields ['value']
        db.create_unique('extra_value', ['value'])
    ...
    models = {
        ...
        u'api.configset': {
            'Meta': {'ordering': "['category_id', 'hwtype_id', 'carrier_id', 'region_id']", 'unique_together': "(('category_id', 'hwtype_id', 'carrier_id', 'region_id', 'delta_name', 'extra_value_id'),)", 'object_name': 'ConfigSet', 'db_table': "'config_set'"},
            ...
            'extra_value_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.ExtraValue']", 'null': 'True', 'db_column': "'extra_value_id'", 'blank': 'True'}),
        ...
        u'api.envtransform': {
            ...
            'extra_level_pat': ('django.db.models.fields.CharField', [], {'default': "'.*'", 'max_length': '255'}),
        ...
        u'api.extravalue': {
            'Meta': {'unique_together': "(('value', 'extra_key_id'),)", 'object_name': 'ExtraValue', 'db_table': "'extra_value'"},
