...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ConfigSet', fields ['region_id', 'delta_name', 'extra_value_id', 'carrier_id', 'hwtype_id', 'category_id']
        db.create_unique('config_set', ['region_id', 'delta_name', 'extra_value_id', 'carrier_id', 'hwtype_id', 'category_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ConfigSet', fields ['region_id', 'delta_name', 'extra_value_id', 'carrier_id', 'hwtype_id', 'category_id']
        db.delete_unique('config_set', ['region_id', 'delta_name', 'extra_value_id', 'carrier_id', 'hwtype_id', 'category_id'])
