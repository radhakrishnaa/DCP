...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnvTransform.extra_level_pat'
        db.add_column('env_transform', 'extra_level_pat',
                      self.gf('django.db.models.fields.CharField')(default='.*', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnvTransform.extra_level_pat'
        db.delete_column('env_transform', 'extra_level_pat')
