...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConfigSet.extra_value_id'
        db.add_column('config_set', 'extra_value_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.ExtraValue'], null=True, db_column='extra_value_id', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConfigSet.extra_value_id'
        db.delete_column('config_set', 'extra_value_id')
